...
Used as the rasterization engine in LOD Viewer for the paper "LetsGo: Large-Scale Garage Modeling and Rendering via LiDAR-Assisted Gaussian Primitives". If you can make use of it in your own research, please be so kind to cite us.
